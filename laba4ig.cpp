...
public:
    ...
    Main()
    {
        ...
        new_spotLight.AmbientIntensity = 0.0f;
        new_spotLight.DiffuseIntensity = 0.9f;
        new_spotLight.Color = Vector3f(1.0f, 1.0f, 1.0f);
        new_spotLight.Attenuation.Linear = 0.01f;
        new_spotLight.Position = Vector3f(-20.0, 15.0, 1.0f);
        new_spotLight.Direction = Vector3f(1.0f, -1.0f, 0.0f);
        new_spotLight.Cutoff = 20.0f;

        lights[0] = m_spotLight;
        lights[1] = new_spotLight;
    }
    ...
    bool Init()
    {
        ...
        m_pLightingEffect->SetSpotLights(2, lights);
        ...
        if (!m_pQuad->LoadMesh("C:/ogldev-master/Content/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/ogldev-master/Content/test.png");
        ...
        return m_pMesh->LoadMesh("C:/ogldev-master/Content/phoenix_ugv.md2");
    }
